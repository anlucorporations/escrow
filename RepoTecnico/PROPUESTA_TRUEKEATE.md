...
> Documento base: `RepoTecno/escrow-TrueKeate.md`
...
**Se recomienda empezar por la Fase 0 (M1)** — el indexador de eventos — porque desbloquea las demás. Cada mejora debe seguir el ciclo del documento: conceptualización → planificación → codificación por módulos → tests → documentación → despliegue, registrando avances en `RepoTecno/`.
