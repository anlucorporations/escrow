...
3. **Pendiente por decisión del director**: validar `RepoTecnico/logica_trueke.md` (punto 5: nomenclatura de tipos, desempate de propuesta de encuentro, alcance de valoración, estado PROPUESTO off/on-chain) y autorizar la migración del modelo de trueque (BD/backend/web/mocks + pruebas).
