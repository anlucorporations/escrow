...
> **NOTA HISTÓRICA**: propuesta de arquitectura frontend previa; la decisión D40 adopta **PWA instalable** en Fase 3 (ver `requerimientos.md` RNF-08/RF-19 y `arquitectura_tecnica.md` §8).
