...
// El usuario (Verificado/Certificado) publica sus Bienes/Servicios/Artículos AtoA
...
const CATEGORIA_NOMBRE: Record<string, string> = Object.fromEntries(
  CATEGORIAS.map((c) => [c.valor, c.nombre])
);
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xs text-navy-800/50">
                    {a.rubro}
                    {a.categoria ? ` · ${CATEGORIA_NOMBRE[a.categoria] ?? a.categoria}` : ""}
                  </p>
                </div>
